...
PLIST_VARS+=			${CRS_NAME}
PLIST.${CRS_DISTNAME}=		yes
BUILD_DEFS+=			NEED_CRS CRS_FILES CRS_DISTNAME
NEED_CRS=			yes
...
do-install:
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/RESPONSE-999-EXCLUSION-RULES-AFTER-CRS.conf.example ${DESTDIR}${EGDIR}/${CRS_DISTNAME}/rules/RESPONSE-999-EXCLUSION-RULES-AFTER-CRS.conf
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/REQUEST-900-EXCLUSION-RULES-BEFORE-CRS.conf.example ${DESTDIR}${EGDIR}/${CRS_DISTNAME}/rules/REQUEST-900-EXCLUSION-RULES-BEFORE-CRS.conf
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/crs-setup.conf.example ${DESTDIR}${EGDIR}/${CRS_DISTNAME}/crs-setup.conf
.for file in ${CRS_FILES}
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/${file} ${DESTDIR}${EGDIR}/${CRS_DISTNAME}/rules/${file}
.endfor
.endif
.if defined(NEED_CRS) || make(makesum)
REPOSITORIES+=			${CRS_DISTNAME}
