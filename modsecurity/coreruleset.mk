...
pre-install:
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/RESPONSE-999-EXCLUSION-RULES-AFTER-CRS.conf.example ${EGDIR}/${CRS_DISTNAME}/rules/RESPONSE-999-EXCLUSION-RULES-AFTER-CRS.conf
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/REQUEST-900-EXCLUSION-RULES-BEFORE-CRS.conf.example ${EGDIR}/${CRS_DISTNAME}/rules/REQUEST-900-EXCLUSION-RULES-BEFORE-CRS.conf
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/crs-setup.conf.example ${EGDIR}/${CRS_DISTNAME}/crs-setup.conf
.for file in ${CRS_FILES}
	${INSTALL_DATA} ${WRKDIR}/${CRS_DISTNAME}/rules/${file} ${EGDIR}/${CRS_DISTNAME}/rules/${file}
.endfor
